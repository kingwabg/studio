...
| 기능 | 판정 | 근거 |
|---|---|---|
| 엑셀/CSV 파싱 `xlsx@0.18.5`(npm) | **공식 배포(cdn.sheetjs.com) 0.20.x로 교체** | npm 배포는 0.18.5에서 중단, **미수정 CVE 2건**(프로토타입 오염 CVE-2023-30533, ReDoS CVE-2024-22363) — 사용자 임의 파일 업로드 경로라 보안 위험. Apache-2.0, API 호환이라 소스만 교체 |
