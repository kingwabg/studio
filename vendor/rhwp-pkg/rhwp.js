...
export class HwpDocument {
     ...
     * @returns {string}
     */
    acceptTrackChange(tc_id) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_acceptTrackChange(this.__wbg_ptr, tc_id);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    applyStyle(sec_idx, para_idx, style_id, overwrite) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_applyStyle(this.__wbg_ptr, sec_idx, para_idx, style_id, isLikeNone(overwrite) ? 0xFFFFFF : overwrite ? 1 : 0);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    debugLineSegTags(section_idx, para_idx) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_debugLineSegTags(this.__wbg_ptr, section_idx, para_idx);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    deleteFormObject(sec_idx, para_idx, control_idx) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_deleteFormObject(this.__wbg_ptr, sec_idx, para_idx, control_idx);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    deleteRangeLogical(section_idx, start_para_idx, start_logical_offset, end_para_idx, end_logical_offset) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_deleteRangeLogical(this.__wbg_ptr, section_idx, start_para_idx, start_logical_offset, end_para_idx, end_logical_offset);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    fitTableToPage(section_idx, parent_para_idx, control_idx) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_fitTableToPage(this.__wbg_ptr, section_idx, parent_para_idx, control_idx);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {number}
     */
    formControlAtLogical(sec_idx, para_idx, logical) {
        const ret = wasm.hwpdocument_formControlAtLogical(this.__wbg_ptr, sec_idx, para_idx, logical);
        return ret;
    }
    /**
     * 문서 내 모든 책갈피 목록 반환
     ...
     * @returns {number}
     */
    getInlineControlIndexAtLogical(section_idx, para_idx, logical_offset) {
        const ret = wasm.hwpdocument_getInlineControlIndexAtLogical(this.__wbg_ptr, section_idx, para_idx, logical_offset);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0];
     ...
     * @returns {string}
     */
    getMasterPages(section_idx) {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.hwpdocument_getMasterPages(this.__wbg_ptr, section_idx);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    getMemos() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.hwpdocument_getMemos(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {string}
     */
    getTableFit(section_idx, parent_para_idx, control_idx) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_getTableFit(this.__wbg_ptr, section_idx, parent_para_idx, control_idx);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    getTables(section_idx) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_getTables(this.__wbg_ptr, section_idx);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    getTrackChanges() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.hwpdocument_getTrackChanges(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {string}
     */
    insertFormObject(sec_idx, para_idx, char_offset, props_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(props_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.hwpdocument_insertFormObject(this.__wbg_ptr, sec_idx, para_idx, char_offset, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    insertSectionBreak(section_idx, para_idx, char_offset) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_insertSectionBreak(this.__wbg_ptr, section_idx, para_idx, char_offset);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    isTrackChangesEnabled() {
        const ret = wasm.hwpdocument_isTrackChangesEnabled(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * 논리적 오프셋 → 텍스트 오프셋 변환.
     ...
     * @returns {string}
     */
    moveFormObject(sec_idx, para_idx, control_idx, props_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(props_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.hwpdocument_moveFormObject(this.__wbg_ptr, sec_idx, para_idx, control_idx, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    offsetCellBoundary(section_idx, parent_para_idx, control_idx, cell_idx, edge, delta) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(edge, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.hwpdocument_offsetCellBoundary(this.__wbg_ptr, section_idx, parent_para_idx, control_idx, cell_idx, ptr0, len0, delta);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    rejectTrackChange(tc_id) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_rejectTrackChange(this.__wbg_ptr, tc_id);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    resolveAllTrackChanges(accept) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.hwpdocument_resolveAllTrackChanges(this.__wbg_ptr, accept);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {string}
     */
    restoreCellBoundary(section_idx, parent_para_idx, control_idx, cell_idx, edge) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(edge, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.hwpdocument_restoreCellBoundary(this.__wbg_ptr, section_idx, parent_para_idx, control_idx, cell_idx, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    setFormObjectProps(sec_idx, para_idx, control_idx, props_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(props_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.hwpdocument_setFormObjectProps(this.__wbg_ptr, sec_idx, para_idx, control_idx, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @param {number} section_idx
     * @param {number} mp_index
     * @param {string} text
     * @returns {string}
     */
    setMasterPageText(section_idx, mp_index, text) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.hwpdocument_setMasterPageText(this.__wbg_ptr, section_idx, mp_index, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @param {boolean} on
     */
    setSquareReflowSuppressed(on) {
        wasm.hwpdocument_setSquareReflowSuppressed(this.__wbg_ptr, on);
    }
    /**
     ...
     * @param {number} parent_para_idx
     * @param {number} control_idx
     * @param {string} widths_json
     * @returns {string}
     */
    setTableColumnWidths(section_idx, parent_para_idx, control_idx, widths_json) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(widths_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.hwpdocument_setTableColumnWidths(this.__wbg_ptr, section_idx, parent_para_idx, control_idx, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @param {string} date
     */
    setTrackChanges(enabled, author, date) {
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.hwpdocument_setTrackChanges(this.__wbg_ptr, enabled, ptr0, len0, ptr1, len1);
    }
    /**
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_set_lineJoin_31ab4da1dfccf1b3: function(arg0, arg1, arg2) {
