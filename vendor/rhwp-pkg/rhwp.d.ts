...
export class HwpDocument {
     ...
     */
    acceptTrackChange(tc_id: number): string;
    /**
     * 책갈피 추가
     */
     ...
     */
    applyStyle(sec_idx: number, para_idx: number, style_id: number, overwrite?: boolean | null): string;
    /**
     ...
     */
    debugLineSegTags(section_idx: number, para_idx: number): string;
    /**
     * 책갈피 삭제
     */
     ...
     * 양식 개체를 삭제한다(삽입의 역연산).
     */
    deleteFormObject(sec_idx: number, para_idx: number, control_idx: number): string;
    /**
     ...
     * 반환: JSON `{"ok":true,"paraIdx":N,"charOffset":N}`
     */
    deleteRangeLogical(section_idx: number, start_para_idx: number, start_logical_offset: number, end_para_idx: number, end_logical_offset: number): string;
    /**
     ...
     */
    fitTableToPage(section_idx: number, parent_para_idx: number, control_idx: number): string;
    /**
     ...
     */
    formControlAtLogical(sec_idx: number, para_idx: number, logical: number): number;
    /**
     * 문서 내 모든 책갈피 목록 반환
     */
    getBookmarks(): string;
     ...
     */
    getInlineControlIndexAtLogical(section_idx: number, para_idx: number, logical_offset: number): number;
    /**
     ...
     */
    getMasterPages(section_idx: number): string;
    /**
     ...
     */
    getTables(section_idx: number): string;
    /**
     ...
     */
    insertFormObject(sec_idx: number, para_idx: number, char_offset: number, props_json: string): string;
    /**
     ...
     */
    insertSectionBreak(section_idx: number, para_idx: number, char_offset: number): string;
    /**
     * 표에 열을 삽입한다.
     *
     * 반환값: JSON `{"ok":true,"rowCount":<N>,"colCount":<M>}`
     ...
     */
    moveFormObject(sec_idx: number, para_idx: number, control_idx: number, props_json: string): string;
    /**
     ...
     */
    offsetCellBoundary(section_idx: number, parent_para_idx: number, control_idx: number, cell_idx: number, edge: string, delta: number): string;
    /**
     * 총 페이지 수를 반환한다.
     */
    pageCount(): number;
     ...
     */
    rejectTrackChange(tc_id: number): string;
    /**
     ...
     */
    restoreCellBoundary(section_idx: number, parent_para_idx: number, control_idx: number, cell_idx: number, edge: string): string;
    /**
     ...
     */
    setFormObjectProps(sec_idx: number, para_idx: number, control_idx: number, props_json: string): string;
    /**
     * 양식 개체 값을 설정한다.
     *
     ...
     */
    setMasterPageText(section_idx: number, mp_index: number, text: string): string;
    /**
     ...
     */
    setSquareReflowSuppressed(on: boolean): void;
    /**
     ...
     */
    setTableColumnWidths(section_idx: number, parent_para_idx: number, control_idx: number, widths_json: string): string;
    /**
     * 표 속성을 수정한다.
     *
     * 반환: JSON `{"ok":true}`
...
export interface InitOutput {
    ...
    readonly hwpdocument_acceptTrackChange: (a: number, b: number) => [number, number, number, number];
    ...
    readonly hwpdocument_applyStyle: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    ...
    readonly hwpdocument_debugLineSegTags: (a: number, b: number, c: number) => [number, number, number, number];
    ...
    readonly hwpdocument_deleteFormObject: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    ...
    readonly hwpdocument_deleteRangeLogical: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    ...
    readonly hwpdocument_fitTableToPage: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    ...
    readonly hwpdocument_getInlineControlIndexAtLogical: (a: number, b: number, c: number, d: number) => [number, number, number];
    ...
    readonly hwpdocument_getMasterPages: (a: number, b: number) => [number, number];
    readonly hwpdocument_getMemos: (a: number) => [number, number];
    ...
    readonly hwpdocument_getTrackChanges: (a: number) => [number, number];
    ...
    readonly hwpdocument_insertFormObject: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    ...
    readonly hwpdocument_insertSectionBreak: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    ...
    readonly hwpdocument_isTrackChangesEnabled: (a: number) => number;
    ...
    readonly hwpdocument_moveFormObject: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    ...
    readonly hwpdocument_offsetCellBoundary: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];
    ...
    readonly hwpdocument_rejectTrackChange: (a: number, b: number) => [number, number, number, number];
    ...
    readonly hwpdocument_resolveAllTrackChanges: (a: number, b: number) => [number, number, number, number];
    readonly hwpdocument_restoreCellBoundary: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
    ...
    readonly hwpdocument_setFormObjectProps: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    ...
    readonly hwpdocument_setMasterPageText: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    ...
    readonly hwpdocument_setSquareReflowSuppressed: (a: number, b: number) => void;
    readonly hwpdocument_setTableColumnWidths: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    ...
    readonly hwpdocument_setTrackChanges: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
