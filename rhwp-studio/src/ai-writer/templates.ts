...
const COMMON_RULES = [
  '객관적 공문체로 작성(~하고자 한다, ~를 목적으로 한다). 1인칭·구어체 금지.',
  '정량 지표는 구체적 수치로. 모르는 수치는 [○○] 로 남기고 지어내지 말 것.',
  '예산·일정·현황은 표, 항목 나열은 목록, 설명은 산문.',
];
...
const TEMPLATES: Template[] = [
  {
    ...
    sections: [
      { heading: '개요', level: 1, rx: '1문단 · 산문 · 보고 목적과 배경' },
      { heading: '추진 현황', level: 1, rx: '표 1개 · 헤더 [구분, 내용, 비고] · 진행 현황을 정량으로' },
      { heading: '주요 결과', level: 1, rx: '목록 · 핵심 성과와 이슈 3~6개' },
      { heading: '향후 계획', level: 1, rx: '목록 · 후속 조치와 일정' },
    ],
  },
  {
    docType: '사업계획서',
